...
export const RESEARCH_NODES: ResearchNodeDef[] = [
  ...
  // ─── REPEATABLE STACKING ─────────────────────────────────
  {
    id: 'gym_eval_tighten',
    trunk: 'alignment',
    name: 'Gym Eval Tightening',
    description: 'Sharpen grader rubrics and holdout splits. Each rank lifts gym quality.',
    costPfDays: 10,
    daysMin: 4,
    prereqs: ['align_sft'],
    maxRanks: 5,
  ...
  },
  {
    id: 'gym_curriculum',
    trunk: 'alignment',
    name: 'Gym Curriculum Design',
    description: 'Sequence harder gym tasks as models clear easier bands. Stacks gym quality.',
    costPfDays: 14,
    daysMin: 5,
    prereqs: ['align_process'],
    maxRanks: 5,
  ...
  },
  {
    id: 'data_ops_refine',
    trunk: 'data',
    name: 'Data Ops Refinement',
    description: 'Repeatable cleaning-pass polish. Each rank compounds the data flywheel.',
    costPfDays: 10,
    daysMin: 4,
    prereqs: ['data_clean'],
    maxRanks: 5,
  ...
  },
  {
    ...
    trunk: 'data',
    name: 'Pipeline Scale-Out',
    description: 'Widen ingest and eval pipelines. Stacks flywheel throughput.',
    costPfDays: 12,
    daysMin: 5,
    prereqs: ['data_eval'],
    maxRanks: 5,
  ...
  },
  {
    id: 'sys_kernel_tune',
    trunk: 'inference',
    name: 'Kernel Tuning Pass',
    description: 'Hand-tune fused kernels for the current fleet. Stacks train speed and usable compute.',
    costPfDays: 12,
    daysMin: 5,
    prereqs: ['sys_kernels'],
    maxRanks: 5,
  ...
  },
  {
    ...
    trunk: 'inference',
    name: 'Host Packing',
    description: 'Pack serving replicas tighter on the same racks. Stacks token speed and hosting opex cuts.',
    costPfDays: 10,
    daysMin: 4,
    prereqs: ['sys_batching'],
    maxRanks: 5,
