    ...
    cloudProviders: [
      {
        ...
        // Opening inventory is intentionally sub-megawatt. The provider
        // growth curve in computeContracts expands this pool over campaign
        // time; it is not a permanent cap on later contracts.
        baselinePf: 960,
        launchBaselinePf: 960,
        maxBaselinePf: 960,
        availablePf: 936,
      ...
      },
      {
        ...
        supportedTrainingFormats: ['fp32', 'fp16_mixed', 'bf16_mixed', 'fp8_hybrid', 'fp6', 'nvfp4'],
        supportedServePrecisions: [
          'fp32',
          'fp16', 'bf16', 'fp8', 'fp6', 'int8', 'int4', 'nvfp4', 'ternary_1_58',
        ],
      },
    ],
...
export function updateLab(state: SimState, labId: LabId, updater: (lab: LabState) => LabState): SimState {
  ...
  if (labId === state.playerLabId) {
    const player: PlayerState = {
      ...
      marketingOutcome: next.marketingOutcome,
