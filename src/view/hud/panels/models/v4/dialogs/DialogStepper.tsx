...
export function DialogStepper<T extends string>({
  steps,
  activeStep,
  onStepChange,
  onCancel,
          ...
          return (
            ...
            >
              <HudButton
                ...
                className={`!flex !min-h-11 !w-full !items-center !justify-center !gap-1 !rounded-md !border-0 !px-1 !text-left !text-[0.6875rem] !font-semibold !uppercase !tracking-[0.1em] transition xl:!justify-start xl:!gap-1.5 xl:!px-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-mint/45 ${
                  active
              ...
              >
                ...
                <span className="hidden min-w-0 whitespace-nowrap xl:inline">{step.label}</span>
              </HudButton>
            </li>
          );
        })}
      </ol>
      <div className="mt-2 flex flex-nowrap items-center gap-2 border-t border-line/45 pt-2">
        <HudButton
          type="button"
          variant="danger"
